...
MCPAR[4] = 10 # Resampleinterval
MCPAR[5] = 150 # stepbase
MCPAR[6] = 200 # steplength

MCMCInitial=np.load('Si2_P21_C19_Init1.npy')
FITPARLB=np.load('Si2_P21_C19_FITPARLB1.npy')
FITPARUB=np.load('Si2_P21_C19_FITPARUB1.npy')
