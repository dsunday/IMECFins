...
Intensity=np.loadtxt('Si2_P25_C25_Int.txt')
Qx = np.loadtxt('Si2_P25_C25_Qx.txt')
Qz = np.loadtxt('Si2_P25_C25_Qz.txt')
...
MCMCInitial=np.load('Si2_P25_C25_Init1.npy')
FITPARLB=np.load('Si2_P25_C25_FITPARLB1.npy')
FITPARUB=np.load('Si2_P25_C25_FITPARUB1.npy')
