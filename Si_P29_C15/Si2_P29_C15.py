...
Intensity=np.loadtxt('Si2_P29_C15_Int.txt')
Qx = np.loadtxt('Si2_P29_C15_Qx.txt')
Qz = np.loadtxt('Si2_P29_C15_Qz.txt')
...
MCMCInitial=np.load('Si2_P29_C15_Init1.npy')
FITPARLB=np.load('Si2_P29_C15_FITPARLB1.npy')
FITPARUB=np.load('Si2_P29_C15_FITPARUB1.npy')
